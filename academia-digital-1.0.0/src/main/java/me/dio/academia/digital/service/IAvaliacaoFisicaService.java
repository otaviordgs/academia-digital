...
public interface IAvaliacaoFisicaService {
   ...
   */
  AvaliacaoFisica create(AvaliacaoFisica form, Aluno aluno);
  ...
  List<AvaliacaoFisica> getAvaliacaoByPeso(double peso);
   ...
   */
  AvaliacaoFisica update(AvaliacaoFisica avaliacaoFisica);

  AvaliacaoFisica update(AvaliacaoFisicaUpdateForm updateForm, Long avaliacaoId);
